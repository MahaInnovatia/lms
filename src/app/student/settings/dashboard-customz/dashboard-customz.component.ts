...
@Component({
  selector: 'app-dashboard-customz',
  templateUrl: './dashboard-customz.component.html',
  styleUrls: ['./dashboard-customz.component.scss']
})
export class DashboardCustomzComponent {
