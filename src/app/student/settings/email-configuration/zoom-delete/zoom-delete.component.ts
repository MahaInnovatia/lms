...
@Component({
  selector: 'app-zoom-delete',
  templateUrl: './zoom-delete.component.html',
  styleUrls: ['./zoom-delete.component.scss']
})
export class ZoomDeleteComponent {
edit = true;
  ...
  getForgetPasswordTemplate() {
    this.emailConfigurationService.getForgetPasswordTemplate().subscribe( response =>{
      this.assignData  = response?.data?.docs[0]?.zoom_meeting_deletion_template;
...
update(){
  ...
  return new Promise<void>((resolve, reject) => {
        ...
        const payload = {
          ...
          insertaction: 'zoom_meeting_deletion_template'
        }
        obj.insertaction = 'zoom_meeting_deletion_template';
