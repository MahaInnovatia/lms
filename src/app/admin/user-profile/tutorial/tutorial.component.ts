...
//     const studenId = params.get('studenId');
//     const courseId = params.get('courseId');
//     this.courseName = params.get('course');
//     this.getTutorialAnswers(studenId, courseId)
//   })

// }
ngOnInit(): void {
  const tutorialData = this.dataService.getData('tutorialData');
...
getTutorialAnswers(studenId: string, courseId: string){
  this.alluserService.getTutorialAnswers(studenId, courseId).subscribe(answers =>{
