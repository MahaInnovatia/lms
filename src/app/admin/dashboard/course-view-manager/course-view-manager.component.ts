...
@Component({
  selector: 'app-course-view-manager',
  templateUrl: './course-view-manager.component.html',
  styleUrls: ['./course-view-manager.component.scss']
})
export class CourseViewManagerComponent {
  breadscrums = [
    {
      title: 'Blank',
